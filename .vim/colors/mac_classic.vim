...
hi MatchParen  guifg=#1E39F6 ctermfg=27 guibg=NONE gui=NONE
...
hi Boolean  guifg=#6E79F1 ctermfg=69 gui=NONE
hi Character  guifg=#D51015 ctermfg=160 gui=NONE
hi Comment  guifg=#0066FF ctermfg=27 gui=NONE
hi Conditional  guifg=#1E39F6 ctermfg=27 gui=NONE
hi Constant  guifg=#D51015 ctermfg=160 gui=NONE
hi Define  guifg=#1E39F6 ctermfg=27 gui=NONE
...
hi Function  guifg=#0000A2 ctermfg=19 gui=NONE
hi Identifier  guifg=#1E39F6 ctermfg=27 gui=NONE
hi Keyword  guifg=#1E39F6 ctermfg=27 gui=NONE
hi Label  guifg=#007B22 ctermfg=28
hi Number  guifg=#0000A2 ctermfg=19
hi Operator  guifg=#1E39F6 ctermfg=27 gui=NONE
hi PreProc  guifg=#1E39F6 ctermfg=27 gui=NONE
hi Special  guifg=#000000 ctermfg=0
hi Statement  guifg=#1E39F6 ctermfg=27 gui=NONE
hi StorageClass  guifg=#1E39F6 ctermfg=27 gui=NONE
hi String  guifg=#007B22 ctermfg=28
hi Title  guifg=#000000 ctermfg=0 gui=NONE
hi Todo  guifg=#0066FF ctermfg=27 gui=NONE
...
hi rubyFunction  guifg=#0000A2 ctermfg=19 gui=NONE
hi rubyInterpolationDelimiter  guifg=#00BC41 ctermfg=35
hi rubyInterpolation  guifg=#00BC41 ctermfg=35
hi rubySymbol  guifg=#D51015 ctermfg=160 gui=NONE
hi rubyConstant  guifg=#6E79F1 ctermfg=69 gui=NONE
hi rubyStringDelimiter  guifg=#007B22 ctermfg=28
hi rubyInstanceVariable  guifg=#318495 ctermfg=66
hi rubyInclude  guifg=#1E39F6 ctermfg=27 gui=NONE
...
hi rubyControl  guifg=#1E39F6 ctermfg=27 gui=NONE
hi rubyOperator  guifg=#1E39F6 ctermfg=27 gui=NONE
hi rubyException  guifg=#1E39F6 ctermfg=27 gui=NONE
hi rubyPseudoVariable  guifg=#318495 ctermfg=66
hi rubyRailsUserClass  guifg=#6E79F1 ctermfg=69 gui=NONE
hi rubyRailsARAssociationMethod  guifg=#3C4C72 ctermfg=240 gui=NONE
hi rubyRailsARMethod  guifg=#3C4C72 ctermfg=240 gui=NONE
hi rubyRailsRenderMethod  guifg=#3C4C72 ctermfg=240 gui=NONE
hi rubyRailsMethod  guifg=#3C4C72 ctermfg=240 gui=NONE
hi link erubyComment Comment
hi erubyRailsMethod  guifg=#3C4C72 ctermfg=240 gui=NONE
...
hi htmlSpecialChar  guifg=#D51015 ctermfg=160 gui=NONE
hi htmlH1 gui=NONE
...
" JavaScript: {{{1
hi javaScriptFunction  guifg=#1E39F6 ctermfg=27 gui=NONE
hi javaScriptFuncName  guifg=#318495 ctermfg=66 gui=NONE
hi javaScriptLabel  guifg=#0000A2 ctermfg=19 gui=NONE
hi javaScriptRailsFunction  guifg=#3C4C72 ctermfg=240 gui=NONE
hi javaScriptType  guifg=#318495 ctermfg=66 gui=none
hi javaScriptArgument  guifg=#318495 ctermfg=66 gui=NONE
...
" CSS: {{{1
hi cssTagName  gui=NONE
hi cssIdentifier  gui=NONE
...
hi cssFunctionName  guifg=#3C4C72 ctermfg=240 gui=NONE
hi cssColor  guifg=#D51015 ctermfg=160 gui=NONE
hi cssValueLength  guifg=#0000A2 ctermfg=19
hi cssImportant  guifg=#1E39F6 ctermfg=27 gui=NONE

" Vimscript: {{{1
hi vimGroup  guifg=#007B22 ctermfg=28 gui=NONE
hi link vimHiGroup vimGroup
hi vimCommentTitle  guifg=#3C4C72 ctermfg=240 gui=NONE
...
hi OL1 guifg=#000000 ctermfg=0 gui=NONE
hi OL2 guifg=#0000A2 ctermfg=19 gui=NONE
hi OL3 guifg=#007B22 ctermfg=28 gui=NONE
